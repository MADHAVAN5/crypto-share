...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input placeholder={placeholder} type={type} step='0.0001' value={value} onChange={() => handleChange(e, name) } className='my-2 w-full rounded-sm outline-none p-2 bg-transparent text-white border-none text-sm white-glassmorphism' />
);
            ...
            <div className="flex mf:flex-row flex-col item-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light mf:w-9/12 w-11/12 text-base">
                        Explore the Crypto world. Buy and sell cryptocurrencies easily on Crypto Share.
                    </p>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorpism">
                        <div className="flex justify-between flex-col w-full h-full">
                            <div className="flex justify-between items-st">
